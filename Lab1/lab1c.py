...
def lab1c(xform1,xform2):
    ...
    t1 = xform1[:2]
    t2 = xform2[:2]
    R1 = get_rotation_matrix(xform1)

    R1t2 = [vectorops.dot(R1[0], t2),vectorops.dot(R1[1], t2)]
    
    return tuple(vectorops.add(R1t2, t1)) +  (xform1[2] + xform2[2],)
