...
class SE2ObstacleCSpace(CSpace):
    ...
    def interpolate(self,a,b,u):
        ...
        while(math.fabs(bAngle - aAngle) > math.pi):
            aAngle += math.copysign(2*math.pi,bAngle - aAngle)

        return vectorops.interpolate((a[0], a[1], aAngle), (b[0], b[1], bAngle) , u)
    ...
    def distance(self,a,b):
        ...
        return vectorops.distance((a[0], a[1], aAngle), (b[0], b[1], bAngle))
